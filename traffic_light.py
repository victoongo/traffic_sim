...
class Car():
    ...
    def draw(self):
        return pygame.draw.rect(self.screen, 'red', (self.pos[0], self.pos[1], 20, 10))
...
while running:
    ...
    for v in grid[0]:
        ...
        pygame.draw.line(screen, 'white', (v-lane_width, 0), (v-lane_width, window_height))
        pygame.draw.line(screen, 'white', (v+lane_width, 0), (v+lane_width, window_height))
    for h in grid[1]:
        pygame.draw.line(screen, 'yellow', (0, h), (window_width, h))
        pygame.draw.line(screen, 'white', (0, h-lane_width), (window_width, h-lane_width))
        pygame.draw.line(screen, 'white', (0, h+lane_width), (window_width, h+lane_width))
